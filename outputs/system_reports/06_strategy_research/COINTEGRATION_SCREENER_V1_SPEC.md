...
>
> ℹ **Amendment (2026-05-23):** Universe expanded again to **31 symbols** by adding **10 equity indices**: US (SPX500, NAS100, US30), EU (UK100, FRA40, ESP35, EUSTX50, GER40), APAC (JPN225, AUS200). Authoritative list lives in `tools/cointegration_screen.py::COINT_UNIVERSE`. Pair-pair count: 153 → 210 → **465**. Most indices carry ~10y of OctaFX history from 2016-01; GER40 is the outlier at ~3y from 2022-03. The `Out of scope (v1)` clause in §1 below previously excluded "Non-FX symbols (XAU/XAG/indices/crypto)" — that boundary has now been deliberately crossed twice (commodities/crypto on 2026-05-21, indices on 2026-05-23) as the screener evolves from FX-only to a true cross-asset cointegration surface. The math is symbol-agnostic; the §1 exclusion is preserved below for historical reading only, not as a current constraint.
>
> ---
