"""
01_MR_FX_1H_ULTC_REGFILT_S07_V1_P01 — Generated by Strategy Provisioner
Directive: 01_MR_FX_1H_ULTC_REGFILT_S07_V1_P01
Patch of: 01_MR_FX_1H_ULTC_REGFILT_S07_V1_P00
Experiment: Ultimate C% variant mode=fast (smooth=1, OB/OS=80/20) — Exp5a
All other logic, filters, exits, and execution rules unchanged from S07 baseline.
"""
...
class Strategy:
    ...
    # --- IDENTITY ---
    name = "01_MR_FX_1H_ULTC_REGFILT_S07_V1_P01"
    timeframe = "1h"

    # Variant controls (identical to S07)
    ...
    def __init__(self):
        ...
        self.uc_mode = str(entry_cfg.get("uc_mode", "baseline"))
