"""
06_PA_XAUUSD_15M_DAYOC_REGFILT_S02_V1_P06 — Generated by Strategy Provisioner
Timestamp: 2026-03-08T14:29:43.065837
Directive: 06_PA_XAUUSD_15M_DAYOC_REGFILT_S02_V1_P06
"""
...
# Patch parameters
_LOW_THRESHOLD = 0.42         # low_threshold_pct / 100
_PERCENTILE_WINDOW = 100              # rolling percentile lookback window
_TRADE_WINDOW_START = pd.Timestamp("2024-01-01", tz="UTC")

class Strategy:
    
    # --- IDENTITY ---
    name = "06_PA_XAUUSD_15M_DAYOC_REGFILT_S02_V1_P06"
    timeframe = "15m"
