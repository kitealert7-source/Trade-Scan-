"""
S08_V1_P00: Wider exit thresholds — RSI 80/20, zscore 0.6.
"""
import pandas as pd
...
class Strategy:
    ...
    # --- IDENTITY ---
    name = "01_MR_FX_1H_ULTC_REGFILT_S08_V1_P00"
    timeframe = "1h"
    ...
    def __init__(self):
        ...
        self.TP_ZSCORE_ABS = float(exit_cfg.get("tp_zscore_abs", self.TP_ZSCORE_ABS))
        self.RSI_EXIT_UPPER = float(exit_cfg.get("rsi_exit_upper", self.RSI_EXIT_UPPER))
        self.RSI_EXIT_LOWER = float(exit_cfg.get("rsi_exit_lower", self.RSI_EXIT_LOWER))
