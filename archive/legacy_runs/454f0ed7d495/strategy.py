"""
S07_V1_P03: uc_mode=slow variant. min_bars_before_exit=3. All other logic from S07_P00.
"""
...
class Strategy:
    ...
    # --- IDENTITY ---
    name = "01_MR_FX_1H_ULTC_REGFILT_S07_V1_P03"
    timeframe = "1h"
    ...
    def __init__(self):
        ...
        self.uc_mode = str(entry_cfg.get("uc_mode", "slow"))
