"""
01_MR_FX_1H_ULTC_REGFILT_S07_V1_P00 — Generated by Strategy Provisioner
Directive: 01_MR_FX_1H_ULTC_REGFILT_S07_V1_P00
Experiment: Minimum hold duration — min_bars_before_exit 3 (Exp2b)
Note: ATR SL, time exit, and opposite-signal exit always fire.
      RSI and Z-score soft exits are blocked until bars_held >= 3.
"""
...
class Strategy:
    ...
    # --- IDENTITY ---
    name = "01_MR_FX_1H_ULTC_REGFILT_S07_V1_P00"
    timeframe = "1h"
    ...
    def check_exit(self, ctx):
        ...
        # Opposite signal exit — always fires (strong reversal signal)
        ult_sig = row.get("ultimate_signal", 0)
