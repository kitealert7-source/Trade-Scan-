"""
S03_V1_P00: ATR SL tightened to 0.9x. All other logic unchanged from S02.
"""
import pandas as pd
...
class Strategy:
    ...
    # --- IDENTITY ---
    name = "01_MR_FX_1H_ULTC_REGFILT_S03_V1_P00"
    timeframe = "1h"
    ...
    def __init__(self):
        ...
        self.atr_multiple = float(stop_cfg.get("multiple", 0.9))
