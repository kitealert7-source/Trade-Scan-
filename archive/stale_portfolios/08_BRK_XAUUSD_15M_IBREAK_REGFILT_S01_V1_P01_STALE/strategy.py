"""
08_BRK_XAUUSD_15M_IBREAK_REGFILT_S01_V1_P01 -- Generated by Strategy Provisioner
Timestamp: 2026-03-09T17:41:17.503245
Directive: 08_BRK_XAUUSD_15M_IBREAK_REGFILT_S01_V1_P01

S01_V1_P01: Asian Session Breakout — wider session window (01:00-08:00 UTC).

Change from P00:
  P00 used session_end="07:00" (6-hour Asian window).
  P01 extends to session_end="08:00" (7-hour window, captures early London).

  The wider window captures the pre-London positioning phase,
  giving a more complete consolidation range. Breakouts fire
  after 08:00 UTC (London active session).

  Vol gate unchanged: NORMAL + HIGH only.
"""
...
_SESSION_END       = "08:00"   # Extended: captures early London
_RANGE_QUALITY_MIN = 0.3
_RANGE_QUALITY_MAX = 2.0
_ALLOWED_REGIMES   = {0, 1}   # NORMAL + HIGH

class Strategy:

    # --- IDENTITY ---
    name = "08_BRK_XAUUSD_15M_IBREAK_REGFILT_S01_V1_P01"
    timeframe = "15m"
