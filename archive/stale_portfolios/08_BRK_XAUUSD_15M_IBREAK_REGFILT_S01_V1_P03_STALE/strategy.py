"""
08_BRK_XAUUSD_15M_IBREAK_REGFILT_S01_V1_P03 -- Generated by Strategy Provisioner
Timestamp: 2026-03-09T17:57:52.512313
Directive: 08_BRK_XAUUSD_15M_IBREAK_REGFILT_S01_V1_P03

S01_V1_P03: Asian Session Breakout — London close exit (16:00 UTC).

Change from P00:
  P00 exits at penultimate bar of day, holding through NY session noise.
  P03 exits at 16:00 UTC (London close), capturing only the London expansion
  move where the breakout edge originates.
...
_EXIT_HOUR_UTC     = 16       # London close

class Strategy:

    # --- IDENTITY ---
    name = "08_BRK_XAUUSD_15M_IBREAK_REGFILT_S01_V1_P03"
    timeframe = "15m"
    ...
    def prepare_indicators(self, df):
        ...
        # London close exit flag — first bar of 16:00 UTC only
        df['is_london_close'] = (df.index.hour == _EXIT_HOUR_UTC) & (df.index.minute == 0)
    ...
    def check_exit(self, ctx):
        ...
        # Exit 1: London close (16:00 UTC)
        if row.get('is_london_close', False):
            return True
