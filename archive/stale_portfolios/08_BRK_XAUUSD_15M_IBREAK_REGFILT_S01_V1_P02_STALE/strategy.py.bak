"""
08_BRK_XAUUSD_15M_IBREAK_REGFILT_S01_V1_P02 -- Generated by Strategy Provisioner
Timestamp: 2026-03-09T17:39:16.075042
Directive: 08_BRK_XAUUSD_15M_IBREAK_REGFILT_S01_V1_P02

S01_V1_P02: Asian Session Breakout — ALL regimes (vol gate removed).

Change from P00:
  P00 restricted entry to NORMAL + HIGH vol regimes only.
  P02 opens to ALL regimes (LOW + NORMAL + HIGH) to test whether
  LOW volatility breakouts also carry edge and to increase trade count.

  P00 had 142 trades (~67/year). Adding LOW regime should bring
  trade frequency closer to the 100+/year target.

Everything else unchanged from P00 baseline.
"""
...
_ALLOWED_REGIMES   = {-1, 0, 1}  # ALL regimes: low, normal, high

class Strategy:

    # --- IDENTITY ---
    name = "08_BRK_XAUUSD_15M_IBREAK_REGFILT_S01_V1_P02"
    timeframe = "15m"
