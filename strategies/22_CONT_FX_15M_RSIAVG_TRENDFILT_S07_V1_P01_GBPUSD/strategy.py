"""
22_CONT_FX_15M_RSIAVG_TRENDFILT_S07_V1_P01 - RSI(2) Average Pullback, FX 15M, Trend-Aligned + USD_SYNTH Z-Score Gate

Same entry/exit logic as S01 P02: trend-aligned RSI(2) pullback strategy.
Added: USD_SYNTH Z-score macro direction gate (Z>=2.0).
...
class Strategy:
    ...
    name = "22_CONT_FX_15M_RSIAVG_TRENDFILT_S07_V1_P01_GBPUSD"
    timeframe = "15m"
    ...
    # --- SIGNATURE HASH: e8b9525d7725d1a6 ---
