...
def _log(msg: str) -> None:
    ...
    try:
        ...
        try:
            # 2MB trigger + 10k-line tail: at ~137 B/line this file averages
            # ~1.4MB at 10k lines, leaving ~5k lines of headroom between
            # rotations. See heartbeat.py for the sizing rationale.
