...
CANONICAL_BLOCKS = [
    ...
    "execution",                 # Portfolio/dispatch infra knobs (concurrency_cap)
...
OPTIONAL_BLOCKS = {
    "order_placement", "trade_management", "execution",
...
# NOTE: Legacy AK30 rename (execution -> execution_rules) was removed when
# 'execution' was reclaimed as a top-level block for portfolio/dispatch
# infra knobs (e.g. concurrency_cap). No active directive relied on the
# legacy form at the time of removal.
MIGRATION_TABLE = {}
...
ALLOWED_NESTED_KEYS = {
    ...
    "execution": {
        # Portfolio-level dispatch knobs shared across research, burn-in, live.
        # Enforced by engines/concurrency_gate.py + apply_portfolio_constraints.py
        # (research), execution_engine/strategy_guard.py (burn-in), and
        # TS_Execution/src/execution_adapter.py (live).
        "concurrency_cap",
    },
    "volatility_filter": {
