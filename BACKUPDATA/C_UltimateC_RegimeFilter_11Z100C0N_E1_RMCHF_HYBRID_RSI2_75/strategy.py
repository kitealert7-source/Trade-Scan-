"""
UltimateC_RegimeFilter_11Z100C0N_E1_RMCHF_HYBRID_RSI2_75 - Generated by Strategy Provisioner
Timestamp: 2026-03-02T20:09:19.647427
Directive: UltimateC_RegimeFilter_11Z100C0N_E1_RMCHF_HYBRID_RSI2_75
"""
...
class Strategy:
    ...
    # --- IDENTITY ---
    name = "UltimateC_RegimeFilter_11Z100C0N_E1_RMCHF_HYBRID_RSI2_75"
    timeframe = "1h"
    ...
    "version": "RM3ZTP040_OPTIONB_Z100_C0N_E1_RMCHF_RSIEXIT_HYBRID_RSI2_75"
}
    ...
    def prepare_indicators(self, df):
        """
        Compute indicator columns required by the strategy.
        """
    ...
    def check_entry(self, ctx):
        ...
        - Long when ultimate_signal == long_signal and abs(trend_score) <= threshold
        - Short when ultimate_signal == short_signal and abs(trend_score) <= threshold
        """
        ...
        # Filter 1: block statistically weak UTC entry hours.
        hour = self._entry_hour_utc(row)
        if hour is not None and hour in self.BLOCKED_UTC_HOURS:
            return None

        # Filter 2: symbol-specific volatility regime gate.
        ...
        # Filter 3: cooldown to prevent immediate post-exit churn.
        idx = getattr(ctx, "index", None)
