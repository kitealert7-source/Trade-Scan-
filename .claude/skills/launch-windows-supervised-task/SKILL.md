...
See [`reference/xml_template.md`](./reference/xml_template.md).
...
Write the template ([`reference/xml_template.md`](./reference/xml_template.md)) to `tools/<scope>/<task>.local.xml` using `[System.IO.File]::WriteAllText(... [System.Text.UnicodeEncoding]::new($false, $true))`. Verify FF-FE-3C-00 first bytes.
